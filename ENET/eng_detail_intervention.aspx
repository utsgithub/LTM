<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="eng_detail_intervention.aspx.cs" Inherits="IMS.About" %>
    ...
    <div class="col-md-9">
      ...
      <table class="table">
        <tr>
          ...
          <td><textarea rows="4" class="form-control">Bootstrap makes front-end web development faster and easier. It's made for folks of all skill levels, devices of all shapes, and projects of all sizes.</textarea></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td><input class="form-control" value="50" /></td>
        </tr>
        <tr>
          <th width="200" nowrap="nowrap">date:</th>
          <td><input class="form-control" value="2015/12/12" /></td>
        </tr>
        <tr>
          <th nowrap="nowrap">&nbsp;</th>
          <td><input type="button" class="btn btn-primary" value="Change"/></td>
        </tr>
      </table>
    </div>
  </div>
