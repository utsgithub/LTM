...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="row">
        ...
        <asp:SqlDataSource ID="RsManIntRow" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT [userName], [interventionTypes_name], [Districts], [comments], [status] FROM [view_detail_interventions] WHERE ([coreInfo_ID] = @coreInfo_ID)">
            <SelectParameters>
